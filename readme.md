## HEADER ## (bg color lightblue)
 -Head section container (margin 0 auto color yellow)
  -Head sections 2x 20 1x60
    -div
       p logo
       p link link link
       p login
...
## FOOTER ##
 ...
 # SECTION 1F # (bg color black)
  - Section container5
   -Section column1-f (bg color pink) height
   -Section column2-f
   -Section column3-f(BG COLOR CYAN)
   -Section column4-f
   -Section column5-f

   # SECTION 2F # (bg color black)
     - Footer section container 
       -Footer section (color watergreen)
        <button class ="login">Login</button><span><button class ="bottone">Bottone</button>
